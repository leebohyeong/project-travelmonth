...
<body id="travelmonth-event-june">
        ...
        <article class="event-june">
            ...
            <section>
                <div class="screen_out"><h2>6월 여행셀럽 준과 떠나는 <br>
                    ...
                    <p><strong>이벤트 기간</strong> 2023.5.17(수) ~ 5.21(일)</p>
                    <p><strong>당첨자 발표</strong> 개별 연락을 통해 별도 안내 예정</p></div>
            </section>
            <section>
                <div class="screen_out"><h2>1차여행</h2>
                    ...
                    <p>대전 출발 → 선운사 및 녹차밭 관람 → <br>
                        ...
                        복분자주스 → 편백숲 치유프로그램→ <br>
                        복분자 족욕 체험 → 대전 도착 → 해산</p>
                    <ul>
                        <li>선운사 및 녹차밭</li>
                        <li>고창농가체험(쉼드림)</li>
                    </ul>
                    <h2>2차여행<p>5/29(월) 서울 출발 → 강원도 춘천 도착(왕복)</p>
                        <p>#힐링/웰니스 #춘천마임축제2023 #당일치기</p>
                        <p>호반의 도시 춘천의 아름다운 조망과 <br>
                ...
                <div class="screen_out"><h2>참여방법</h2>
                    <ul>
                        ...
                        <li><strong>STEP 2</strong> <br>
                            구글 시트에서 희망하는 단체여행을 선택하고 <br>
                            준이와 여행을 떠나고 싶은 사연 입력
                        </li>
                        <li><strong>STEP 3</strong> <br>
                            구글 시트에서 신청인 개인정보와 <br>
                            동반인 이름(선택사항, 최대 1인), <br>
                            본인과의 관계를 입력
                        </li>
                    </ul>
            ...
            <section>
                <div class="screen_out"><p>이벤트는 개인정보 연락처 기준 1인 당 1회만 참여 가능합니다. (중복참여 불가)</p>
                    ...
                    <p>참가신청 마감 후에는 여행 참가자의 변경과 양도가 불가능합니다.</p>
                    <p>여행 신청 대표자 및 동반자의 잘못된 개인정보 입력으로 인한 당첨의 불이익은 책임지지 않습니다.</p>
                    <p>단체여행은 출발지에서 버스에 탑승하여 이동하며, 집결장소와 출발/도착시간과 관련 자세한 사항은</p>
                    <p>별도 개별 연락을 통해 안내해 드립니다.</p>
                    <p>춘천마임축제 단체여행의 경우,
                        &#60;김해준&#62; 유튜브 채널에 콘텐츠로 사용될 수 있습니다.
                    </p>
                    <p>본 단체여행 이벤트에는 여행자 보험이 포함되어 있으며, 여행에 이용되는 교통수단(전세버스)은</p>
                    <p>별도의 손해배상 보험에 가입되어 있습니다.</p>
                    <p>개인정보동의로 수집된 개인정보는 개인정보 보호법 규정에 의거하여 처리되며,</p>
                    <p>이벤트 종료 후 3개월간 보유되며, 이 후에는 안전한 방식으로 폐기됩니다.</p></div>
            </section>
            <div class="event-june__modal modal fade" id="juneModal1" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body"><img src="/travelmonth/assets/images/event/june/img_event_june_modal_1.jpg">
                            <div class="screen_out">
                                <table>
                                    ...
                                    <tr>
                                        <td>집결(대전역)</td>
                                        <td>8:00</td>
                                        <td>대전역 주차장앞 출발→ 경부선 고속철도1번 출구 주차장</td>
                                    </tr>
                                    <tr>
                                        <td>버스탑승 및 이동</td>
                                        <td>9:00-10:50</td>
                                    ...
                                    <tr>
                                        <td>버스탑승 및 이동</td>
                                        <td>12:30~12:40</td>
                                        <td>농가체험장 쉼드림 도착 및 프로그램 소개</td>
                                    </tr>
                                    <tr>
                                        <td>점심식사</td>
                                        <td>12:40~13:30</td>
                                        <td>중식(바비큐세팅 및 팜파티)</td>
                                    </tr>
                                    <tr>
                                        <td>간단한 티타임</td>
                                        <td>13:30~14:00</td>
                                        <td>핸드드립 맷돌커피 체험 & 복분자주스 시음</td>
                                    </tr>
                                    <tr>
                                        <td rowspan="2">편백수 치유프로그램</td>
                                        <td>14:00~15:00</td>
                                        <td>편백숲 치유프로그램
                                            자연과 하나되는 피크닉~
                                            → 그룹미션
            ...
            <div class="event-june__modal modal fade" id="juneModal2" data-bs-backdrop="static" data-bs-keyboard="false"
                 tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body"><img src="/travelmonth/assets/images/event/june/img_event_june_modal_2.jpg">
                            <div class="screen_out">
                                <table>
                                    <thead>
                                    <tr>
