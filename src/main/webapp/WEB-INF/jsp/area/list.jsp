		...
		<div class="benefits">
			<div class="benefits__container">
				...
				<div class="benefits__content">
					<article class="benefits-local" data-local="10">
							<header>
											...
											<c:forEach var="row" items="${list}" varStatus="loop">
												<li>
													<a href="#" data-type="d" data-bs-toggle="modal" data-bs-target="#modal-benefits-1">
														<span style="background-image: url('https://cdn.visitkorea.or.kr/img/call?cmd=VIEW&amp;id=3f8fbd92-6b7e-46ba-9161-21bfd76e8e1b&amp;mode=progress')"></span>
														<div>
															<p>${row.travel_type}</p>
															<p>어뮤즈월드</p>
														</div>
