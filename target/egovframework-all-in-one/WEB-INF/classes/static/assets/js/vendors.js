...
/***/ "./node_modules/hwaly-app/src/App.js":
/*!*******************************************!*\
  !*** ./node_modules/hwaly-app/src/App.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const App = (() => {
  const _methods = {};
  const _autoMethodNames = /* @__PURE__ */ new Set();
  return class {
    constructor(options) {
      this._setUsePrefix();
    ...
    _getMethods() {
      ...
      if (appNames.length) {
        appNames.reduce((methods2, name, index) => {
          const beforeName = methods2.names[index];
          const currentName = toUpperFirstLetter(name.trim());
          const mergeName = `${beforeName}${currentName}`;
          methods2.names.push(mergeName);
          methods2.name = mergeName;
          return methods2;
        }, methods);
      }
